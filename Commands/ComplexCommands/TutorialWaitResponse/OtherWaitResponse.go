{{/*
  ...
  Altered/Modded by: Crenshaw#1312 for 
  Trigger Type: RegEx
  Trigger: .* (configure actual trigger in configuration values below)
  
  Note from Crenshaw#1312: Hey, I made this in hopes of making it easier to 
customize/add more questions, along the way I also added a responses logger
This CC is also an absolute fucking mess with the styling, it's a slash of DZ's and My own (they don't mix)
*/}}
